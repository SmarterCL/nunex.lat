    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-white via-blue-50 to-emerald-50 backdrop-blur-sm border-b-2 border-emerald-200">
      <nav className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:block">
          <button className="bg-gradient-to-r from-blue-600 to-emerald-600 text-white px-6 py-2 rounded-full text-sm font-semibold hover:shadow-lg hover:shadow-emerald-400/50 transition-all">
            Solicitar Acceso
          </button>
        </div>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white border-t-2 border-blue-100 p-4 space-y-3">
          ...
          <button className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 text-white px-6 py-2 rounded-full text-sm font-semibold hover:shadow-lg mt-2">
            Solicitar Acceso
          </button>
        </div>
      )}
