      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-12 lg:flex-row lg:gap-24">
        <article className="mx-auto">
          ...
          <div className="prose dark:prose-invert">
            ...
            <p>
              The king thought long and hard, and finally came up with <a href="#">a brilliant plan</a>: he would tax
        ...
        <aside className="lg:max-w-[300px]">
          <div className="border-border bg-accent flex flex-col items-start rounded-lg border py-6 md:py-8">
            ...
            <div className="mb-5 px-6 last:mb-0">
              ...
              <div className="text-muted-foreground overflow-hidden text-xs md:text-sm">{currentProject.company}</div>
            </div>
            <div className="mb-5 px-6 last:mb-0">
              <div className="mb-2 text-xs font-semibold">Industry</div>
              <div className="text-muted-foreground overflow-hidden text-xs md:text-sm">{currentProject.industry}</div>
            </div>
            <div className="border-border mb-5 w-full border-t px-6 pt-5 last:mb-0">
              ...
              <div className="text-muted-foreground overflow-hidden text-xs md:text-sm">{currentProject.location}</div>
            </div>
            <div className="mb-5 px-6 last:mb-0">
              ...
              <div className="text-muted-foreground overflow-hidden text-xs md:text-sm">
                {currentProject.companySize}
              </div>
            </div>
            <div className="mb-5 px-6 last:mb-0">
              <div className="mb-2 text-xs font-semibold">Website</div>
              <div className="text-muted-foreground overflow-hidden text-xs md:text-sm">
                <a href={currentProject.website} className="hover:text-foreground underline">
            ...
            <div className="mb-5 px-6 last:mb-0">
              ...
              <div className="text-muted-foreground overflow-hidden text-xs md:text-sm">{currentProject.topics}</div>
            </div>
          </div>
        </aside>
      </div>
